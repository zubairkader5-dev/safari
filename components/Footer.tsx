  ...
  return (
    <footer className="footer">
      <div className="shell footer-grid">
        ...
        <div><p className="footer-label">Legal</p><div className="footer-links"><span>Privacy Policy – YES / Required</span><span>Terms & Conditions – YES / Required</span><span>POPIA Policy – TO BE CONFIRMED WITH WEBSITE DEVELOPER/LEGAL ADVISER based on the company's target markets and applicable data-protection requirements.</span></div></div>
