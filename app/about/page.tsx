...
export default function AboutPage() {
  return <main className="subpage">
    ...
    <section className="section"><div className="shell guide-profile"><div className="guide-photo-placeholder guide-photo-placeholder--light"><div className="guide-initials">MZ</div><div className="guide-photo-note">Professional guide portrait coming soon</div></div><div><p className="eyebrow">Team</p><h2>Masuzyo Zimba</h2><p><strong>Position: Director / Safari Guide</strong></p><p>{masuzyoBio}</p></div></div></section>
